...
* **Área de Drop de Nível Raiz Superior:** Nova zona de drop delimitada e de alto destaque estético no topo da listagem de contas, permitindo arrastar qualquer subconta nela para transformá-la instantaneamente em uma Conta Mestre (Nível Superior / Sem Pai).
