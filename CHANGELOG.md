...
- feat(ui): Ajustes na tabela do Hist�rico (sem rolagem), edi��o r�pida de lan�amentos, pesquisa por valores, altera��o do �cone de veloc�metro para alvo e aviso explicativo de 'Valor Bruto'.
