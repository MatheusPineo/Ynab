...
export const COUNTRIES: Country[] = [
  ...
  { code: "CW", name: "ilha da Curação" },
  { code: "IM", name: "Ilha de Man" },
  { code: "CX", name: "Ilha do Natal" },
  { code: "TW", name: "Ilha Formosa" },
  ...
  { code: "SJ", name: "Ilhas Svalbard e Jan Mayen" },
  { code: "TC", name: "Ilhas Turks e Caicos" },
  { code: "VG", name: "Ilhas Virgens" },
  { code: "VI", name: "Ilhas Virgens dos Estados Unidos" },
  { code: "IN", name: "Índia" },
  ...
  { code: "SX", name: "São Martinho" },
  { code: "MF", name: "São Martinho" },
  { code: "ST", name: "São Tomé e Príncipe" },
  { code: "VC", name: "São Vincente e Granadinas" },
  ...
  { code: "TO", name: "Tonga" },
  { code: "TT", name: "Trinidade e Tobago" },
